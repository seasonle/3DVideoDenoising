...
mainpath = 'A:\PROJECTS\2019_11_AIP\DnCNN\matconvnet-master\matconvnet-master\DnCNN\TrainingCodes\DnCNN_TrainingCodes_DagNN_v1.1';
...
for i = 1 : length(filePaths)
    ...
    if showresult
        ...
        imwrite(c,fullfile(mainpath,folderResultCur, [nameCur, '_compare_', extCur]));
        imwrite(im2uint8(output),fullfile(mainpath,folderResultCur, [nameCur, extCur]));
